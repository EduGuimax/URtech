...
;
const metadata = {
    title: "URTECH - Soluções Tecnológicas Inteligentes",
    description: "Software exclusivos, automação de processos, drones especializados e manutenção científica com IA. Transforme sua empresa com a URTECH.",
    generator: "v0.app",
    icons: {
        icon: [
            {
